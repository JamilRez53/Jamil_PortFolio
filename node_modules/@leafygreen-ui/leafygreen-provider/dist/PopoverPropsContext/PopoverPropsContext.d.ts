...
export declare const PopoverPropsContext: React.Context<PopoverPropsProviderProps>;
/**
 * Access the popover props context to read props passed to nested popover component instances
 */
export declare const usePopoverPropsContext: () => PopoverPropsProviderProps;
/**
 ...
 */
export declare const PopoverPropsProvider: {
    ({ children, ...props }: PropsWithChildren<PopoverPropsProviderProps>): React.JSX.Element;
    displayName: string;
    propTypes: {
        children: PropTypes.Requireable<PropTypes.ReactNodeLike>;
    };
};
//# sourceMappingURL=PopoverPropsContext.d.ts.map